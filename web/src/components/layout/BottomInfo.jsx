...
function BottomInfo() {
  ...
  const [dept, setDept] = useState('Default Dept');
  ...
  getUserSettings(loggedInUser).then((res) => {
    ...
    setDept(res.data.defaultDeliveryLocation);
  }).catch(() => {
    logout();
  });
  ...
  return (
    <div className="mx-5 my-8 gap-2 grid grid-flow-row-dense grid-cols-4 ...">
      <div className="col-span-3">
        <b id="bottomInfoName" className="text-gray-500">{name}</b>
        <br />
        <b>{dept}</b>
      </div>
      <div className="col-span-2">
        <a href="/settings">
          <button type="button" className="bg-gray-300 hover:bg-gray-400 text-gray-600 rounded w-full p-0.5">
            <svg className="svg-icon w-5 h-5 inline" viewBox="0 0 20 20">
      ...
      <div className="col-span-2">
        <a href="/login">
          <button type="button" className="bg-gray-300 hover:bg-gray-400 text-gray-600 rounded w-full p-0.5" onClick={logout}>
            <svg className="svg-icon w-5 h-5 inline" viewBox="0 0 20 20" transform="matrix(-1,0,0,1,0,0)">
