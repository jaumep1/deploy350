...
function Navbar({ children }) {
  return (
    <nav className="h-[7vh] z-30 w-full bg-white border-b border-gray-200">
      <div className="px-3 py-3 lg:px-5 lg:pl-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
            ...
            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">{children}</span>
          </div>
        </div>
      </div>
    </nav>
